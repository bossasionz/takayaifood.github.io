...
let AddItemComponent = class AddItemComponent {
    constructor(itemService, detail) {
        ...
        this.items$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(this.nameFilter, this.telFilter, this.addressFilter).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(([name, tel, address]) => {
            return detail.collection('items', ref => {
                let query = ref;
                if (name) {
...
let ItemService = class ItemService {
    constructor(detail, menuOrder, firebaseAuth) {
        this.detail = detail;
        ...
        this.menus = this.menuOrder.collection('totalOrder').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(changes => {
        ...
        this.items = this.detail.collection('items').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(changes => {
            return changes.map(a => {
                const data = a.payload.doc.data();
                data.id = a.payload.doc.id;
                return data;
